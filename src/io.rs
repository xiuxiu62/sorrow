...
pub unsafe fn outw(port: u16) -> u16 {
    u16::read_from_port(port) 
}

pub unsafe fn outl(port: u16) -> u32 {
    u32::read_from_port(port) 
}

pub unsafe fn insb(port: u16, val: u8) {
    u8::write_to_port(port, val); 
}

pub unsafe fn insw(port: u16, val: u16) {
    u16::write_to_port(port, val); 
}

pub unsafe fn insl(port: u16, val: u32) {
